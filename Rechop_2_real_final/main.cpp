...
int pop2(antenne& Antenne,int j){
...
void push2(antenne& Antenne,int valeur, int position){
    int g[5];
    for (int i=0;i<Antenne.size_antennes;i++){
        g[i]=Antenne.liste_antenne[i];
    }
        ...
        for(int compteur =0;compteur < taille_final;compteur++){
            ...
            while (a){
                ...
                if (sol2.solutions_list[i].Antenne[iboucle].size_antennes == 0 || sol2.solutions_list[j].Antenne[jboucle].size_antennes == 5 ){
                    ...
                    //j1 =2;
                    push(sol2.solutions_list[j].Antenne[jboucle],pop(sol2.solutions_list[i].Antenne[iboucle],i1));
                    a = false;
                }
            }
        ...
        // on remplit aussi la distribution
            if (p<1){
                ...
                while (a) {
                    ...
                    //jboucle = -1;
                    if ((iboucle == -1) && sol3.solutions_list[i].Antenne_distribution.size_antennes >0 && sol3.solutions_list[j].Antenne_distribution.size_antennes >0){
                        i1 = hasard(0,sol3.solutions_list[i].Antenne_distribution.size_antennes-1);
                        j1 = hasard(0,sol3.solutions_list[j].Antenne_distribution.size_antennes-1);
                        int a1 = sol3.solutions_list[i].Antenne_distribution.liste_antenne[i1];
                        int a2 = sol3.solutions_list[j].Antenne_distribution.liste_antenne[j1];
                        sol3.solutions_list[i].Antenne_distribution.liste_antenne[i1] = a2;
                        sol3.solutions_list[j].Antenne_distribution.liste_antenne[j1] = a1;
                        //i1 = hasard(0,sol3.solutions_list[i].Antenne_distribution.size_antennes-1);
                        //j1 = hasard(0,sol3.solutions_list[j].Antenne_distribution.size_antennes);
                        //push(sol3.solutions_list[j].Antenne_distribution,pop(sol3.solutions_list[i].Antenne_distribution,i1));
                        a = false;
                        ...
                        //j1 = hasard(0,sol3.solutions_list[j].Antenne_distribution.size_antennes);
                        //j1 =2;
                        push(sol3.solutions_list[j].Antenne_distribution,pop(sol3.solutions_list[i].Antenne[iboucle],i1));
                        a = false;
                    }
                }
